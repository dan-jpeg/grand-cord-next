    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="flex flex-row">
                <p className="text-right pl-[5rem] leading-3 hidden md:block font-helvetica md:w-[620px] text-[6.5pt] italic">
                ...
                <p className="uppercase font-bold text-[9pt] pl-[8rem] pr-[0] rotate-90 md:rotate-0 whitespace-nowrap">grand-cord</p>
            </div>
            <div className="h-40" />
            <div className="h-16" />
            ...
            <section className="py-24">
                ...
                <div className="grid border-t border-black/20 grid-cols-1 gap-x-1.5 gap-y-16 pb-0 md:grid-cols-2 lg:grid-cols-3">
