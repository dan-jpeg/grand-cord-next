...
export function DesktopCatalogShell({
    products,
    welcomeMessage,
}: {
    ...
    return (
        <div className="min-h-[calc(100*var(--vh))] font-inter bg-white">
            <div className="px-[calc(9*var(--vw))] lg:grid grid-cols-12 pt-[calc(100*var(--vh)-200px)] gap-y-[260px] w-full">
